...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(easejs_TEXINFOS) $(top_srcdir)/tools/mdate-sh \
	$(srcdir)/version.texi $(srcdir)/stamp-vti \
	$(top_srcdir)/tools/texinfo.tex README
...
am__v_texidevnull_1 = 
INFO_DEPS = $(srcdir)/easejs.info
TEXINFO_TEX = $(top_srcdir)/tools/texinfo.tex
am__TEXINFO_TEX_DIR = $(top_srcdir)/tools
DVIS = easejs.dvi
PDFS = easejs.pdf
PSS = easejs.ps
HTMLS = easejs.html
TEXINFOS = easejs.texi
TEXI2DVI = texi2dvi
...
$(srcdir)/easejs.info: easejs.texi $(srcdir)/version.texi $(easejs_TEXINFOS)
easejs.dvi: easejs.texi $(srcdir)/version.texi $(easejs_TEXINFOS)
easejs.pdf: easejs.texi $(srcdir)/version.texi $(easejs_TEXINFOS)
easejs.html: easejs.texi $(srcdir)/version.texi $(easejs_TEXINFOS)
$(srcdir)/version.texi:  $(srcdir)/stamp-vti
$(srcdir)/stamp-vti: easejs.texi $(top_srcdir)/configure
	@(dir=.; test -f ./easejs.texi || dir=$(srcdir); \
	set `$(SHELL) $(top_srcdir)/tools/mdate-sh $$dir/easejs.texi`; \
...
mostlyclean-aminfo:
	-rm -rf easejs.t2d easejs.t2p

clean-aminfo:
	-test -z "easejs.dvi easejs.pdf easejs.ps easejs.html" \
	|| rm -rf easejs.dvi easejs.pdf easejs.ps easejs.html
...
.PHONY: all all-am check check-am clean clean-aminfo clean-generic \
	...
	distclean-generic distdir dvi dvi-am dvi-local html html-am \
	...
	ps-am tags-am uninstall uninstall-am uninstall-dvi-am \
